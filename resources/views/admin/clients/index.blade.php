                    ...
                    <td>
                        ...
                        @else
                            <div class="avatar avatar-xs">
                                <span class="avatar-initial rounded bg-label-primary"><i class="bi bi-building"></i></span>
                            </div>
                        @endif
                    </td>
                    <td>
                        <span class="fw-semibold">{{ $client->title }}</span>
                    </td>
                    <td>
                        <small class="d-block text-muted">
                            <i class="bi bi-telephone me-1"></i> {{ $client->contact_number ?: 'N/A' }}
                        </small>
                        <small class="d-block text-muted">
                            <i class="bi bi-envelope me-1"></i> {{ $client->contact_email ?: 'N/A' }}
                        </small>
                    </td>
                    <td>
                        <small class="fw-medium">{{ $client->hr_name ?: 'N/A' }}</small>
                        @if($client->hr_contact || $client->hr_email)
                        <small class="d-block text-muted">
                            {{ $client->hr_contact }} {{ $client->hr_email ? '| ' . $client->hr_email : '' }}
                        </small>
                        @endif
                    </td>
                    <td>
