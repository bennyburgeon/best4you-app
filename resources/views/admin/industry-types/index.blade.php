...
<div class="card shadow-sm border-0">
    <div class="card-header d-flex justify-content-between align-items-center border-bottom-0 pb-0">
        <div>
            <h5 class="card-title mb-1 fw-bold">Industry Types</h5>
            <small class="text-muted">Manage the industries you recruit for</small>
        </div>
        ...
        <div class="table-responsive text-nowrap rounded-3 border">
            <table class="table table-hover mb-0">
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="d-flex justify-content-center gap-2">
                                ...
                                <form action="{{ route('industry-types.destroy', $item->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this industry type?');">
                                    @csrf
                                    @method('DELETE')
                    ...
                    @empty
                    <tr>
                        <td colspan="3" class="text-center py-4 text-muted">No industry types found. Click "Add Industry" to create one.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
