                ...
                <form action="{{ route('job-categories.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-8 mb-3">
                            ...
                            <input type="text" class="form-control" id="name" name="name" placeholder="e.g., Information Technology" value="{{ old('name') }}" required />
                            @error('name')
                        ...
                        <div class="col-12 col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" id="symbol" name="symbol" placeholder="e.g., IT" value="{{ old('symbol') }}" />
                            @error('symbol')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
                        </div>
